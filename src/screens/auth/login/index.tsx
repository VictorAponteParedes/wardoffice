        ...
        >
            ...
            >
                <div className="flex flex-col md:flex-row">
                    {/* Panel izquierdo */}
                    <div className="hidden md:flex flex-1 bg-gradient-to-br from-blue-700 to-blue-900 items-center justify-center p-12 relative overflow-hidden">
                    ...
                    <div className="flex-1 p-10 lg:p-16">
                        <div className="max-w-md mx-auto">
                            ...
                            <div className="md:hidden mt-10 text-center">
                                <img src={sudLogo} alt="Logo" className="w-36 mx-auto rounded-lg shadow-lg" />
                            </div>
                        </div>
                    </div>
                </div>
