                ...
                <div className="p-6 space-y-8">
                    ...
                    <nav className="space-y-6">
                        ...
                        >
                            ...
                            <span className="font-medium">{translate("Sidebar.dashboard")}</span>
                        </Link>
                        ...
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <span className="font-medium">{translate("Sidebar.members")}</span>
                            </div>
                            <motion.div
                        ...
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <span className="font-medium">{translate("Sidebar.talks")}</span>
                            </div>
                        ...
                        >
                            ...
                            <span className="font-medium">{translate("Sidebar.callings")}</span>
                        </Link>
